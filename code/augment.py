...
ap.add_argument("--output_df", required=True, type=str, help="output dataframe of augmented data")
...
def gen_eda(train_df, output_df, alpha_sr, alpha_ri, alpha_rs, alpha_rd, num_aug=9):
...
if __name__ == "__main__":
    ...
    gen_eda(args.input_df, args.output_df, alpha_sr=alpha_sr, alpha_ri=alpha_ri, alpha_rs=alpha_rs, alpha_rd=alpha_rd, num_aug=num_aug)
